...
class AppSettingListTile<T> extends StatelessWidget {
  ...
  factory AppSettingListTile.dropDown({
  ...
  factory AppSettingListTile.switcher({
    required String title,
  ...
  factory AppSettingListTile.custom({
    required String title,
